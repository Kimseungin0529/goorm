...
import com.doong.practice.member.MemberRepository;
import com.doong.practice.order.Order;
import com.doong.practice.order.OrderRepository;
...
class OrderTest {
    ...
    void gogo(){
        ...
        memberRepository.findMemberByJpql(member1.getMemberId()).orElseThrow(() -> new IllegalArgumentException("실패"));
